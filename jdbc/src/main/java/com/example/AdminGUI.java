...
public class AdminGUI extends JFrame {
	...
	public void initialize() {
		...
		squareimg.setIcon(new ImageIcon(
				"C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\square.png"));
		...
		rectangleimg.setIcon(new ImageIcon(
				"C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\rectangle.png"));
		...
		hexagonimg.setIcon(new ImageIcon(
				"C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\hexagon.png"));
		...
		octagonimg.setIcon(new ImageIcon(
				"C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\octagon.png"));
		...
		rec_up_Btn.setIcon(
				new ImageIcon("C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\up.png"));
		...
		rec_down_Btn.setIcon(new ImageIcon(
				"C:\\Users\\User\\Desktop\\Personal\\Programing\\JAVA\\vscode\\jdbc\\btnImage\\down.png"));
												...
												numLabel.setFont(new Font("아임크리수진", Font.PLAIN, 40));
														...
														admnum_Field.setColumns(10);
																...
																pwLabel.setFont(new Font("아임크리수진", Font.PLAIN, 40));
																		...
																		panel.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{numLabel, admnum_Field, pwLabel, pass_Field}));
																		Login_panel.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{admnum_Field, pass_Field, LoginBtn, numLabel, pwLabel, panel, TitleLabel}));
		...
		editBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (selected_order.getValueAt(0, 1) == null) {
					...
					newEditFrame.getContentPane().setLayout(null);
					...
					newEditFrame.getContentPane().add(orderNumLabel);

					JLabel nameLabel = new JLabel("이름:");
					nameLabel.setFont(new Font("아임크리수진", Font.PLAIN, 20));
					nameLabel.setBounds(20, 50, 100, 20);
					newEditFrame.getContentPane().add(nameLabel);
					...
					newEditFrame.getContentPane().add(orderNumValueLabel);
					...
					newEditFrame.getContentPane().add(nameTextField);
					...
					newEditFrame.getContentPane().add(phoneTextField);
					...
					newEditFrame.getContentPane().add(customComboBox);
					...
					newEditFrame.getContentPane().add(modifyButton);
								...
								if (phoneTextField.getText().trim().equals("")) {
									...
									if (styleComboBox.getSelectedItem().toString() == "") {
										...
										if (customComboBox.getSelectedItem().toString() == "") {
											...
											if (amt_check) {
												int[] columnwidth = { 38, 57, 84, 90, 69, 150 };
												int ans = JOptionPane.showConfirmDialog(null, "정말로 변경하시겠습니까?",
														"주문정보 변경", JOptionPane.YES_NO_OPTION,
												...
												if (ans == 0) {
													...
													JSS.edtOrder_mat(String.valueOf(selected_order.getValueAt(3, 1)),
															styleComboBox.getSelectedItem().toString());

													String[][] list_data = JSS.OrderTable();

													// 테이블 모델에 데이터 적용
													DefaultTableModel model = (DefaultTableModel) order_list.getModel();
													model.setDataVector(list_data, new String[] { "ID", "NAME", "PHONE",
															"MATERIAL", "CUSTOM", "DATE" });
													...
													JOptionPane.showMessageDialog(null, "주문정보가 변경되었습니다.", "변경 완료",
															JOptionPane.PLAIN_MESSAGE);
		...
		cancelBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (selected_order.getValueAt(0, 1) == null) {
					JOptionPane.showMessageDialog(null, "주문을 선택하지 않았습니다.", "주문을 선택해 주세요", 0);
				} else {
					int[] columnwidth = { 38, 57, 84, 90, 69, 150 };
					int ans = JOptionPane.showConfirmDialog(null, "정말로 삭제하시겠습니까?", "주문정보 삭제", JOptionPane.YES_NO_OPTION,
							JOptionPane.PLAIN_MESSAGE);
					if (ans == 0) {
						...
						// 테이블 모델에 데이터 적용
						DefaultTableModel model = (DefaultTableModel) order_list.getModel();
						model.setDataVector(list_data,
								new String[] { "ID", "NAME", "PHONE", "MATERIAL", "CUSTOM", "DATE" });
